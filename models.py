...
class DocumentType(Base):
    ...
    flows     = relationship("ApprovalFlow", back_populates="document_type")
...
class Document(Base):
    ...
    uploaded_by      = Column(Integer, ForeignKey("staffs.id"), nullable=False)
    ...
    logs          = relationship("ApprovalLog", back_populates="document", cascade="all, delete-orphan")
...
class ApprovalFlow(Base):
    ...
    document_type = relationship("DocumentType", back_populates="flows")
...
class ApprovalStep(Base):
    ...
    approver_id    = Column(Integer, ForeignKey("staffs.id"), nullable=True)
    ...
    approver = relationship("Staff", foreign_keys=[approver_id])
...
class ApprovalLog(Base):
    ...
    step_order  = Column(Integer, nullable=False)
    approver_id = Column(Integer, ForeignKey("staffs.id"), nullable=False)
...
class Notification(Base):
    ...
    recipient_id  = Column(Integer, ForeignKey("staffs.id"), nullable=False)
    ...
    recipient = relationship("Staff", foreign_keys=[recipient_id])
...
class Announcement(Base):
    ...
    author_id  = Column(Integer, ForeignKey("staffs.id"), nullable=False)
...
class CustomerMemo(Base):
    ...
    id          = Column(Integer, primary_key=True, autoincrement=True)
    hospital    = Column(String(300), nullable=False)
...
class Task(Base):
    ...
    created_by  = Column(Integer, ForeignKey("staffs.id"), nullable=False)
